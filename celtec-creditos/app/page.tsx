  ...
  return (
    <main>
      ...
      <section className="bg-bg px-5 pt-12 pb-12 text-center">
        <p className="font-mono text-sm uppercase tracking-[0.25em] text-celtec-green mb-3 font-bold">
          CelTec · Mexicali
        </p>

        {/* WhatsApp prominente debajo del nombre */}
        <a
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-7 h-7 flex-shrink-0" fill="#22C55E">
          ...
          <span className="text-ink text-2xl font-mono font-bold tracking-wide">
            686 290 14 48
          </span>
        </a>
      ...
      {/* TÍTULO CATÁLOGO — fondo oscuro, letras grandes */}
      ...
      {/* TÍTULO SIMULADOR — fondo oscuro, letras grandes */}
      <section className="bg-bg px-5 pt-10 pb-6 text-center border-t border-white/10">
        <h2 className="font-display font-bold text-3xl text-ink">
