    ...
    <div className="fixed inset-0 z-50 bg-bg/90 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-4">
      <div className="bg-surface border border-white/10 rounded-t-2xl sm:rounded-2xl p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-start justify-between mb-5">
          ...
          <button type="button" onClick={onClose} className="text-inkmuted hover:text-ink text-2xl leading-none" aria-label="Cerrar">×</button>
        </div>
        ...
        {paso === "enviado" && (
          <div className="text-center space-y-3 py-4">
            ...
            <p className="text-inkmuted text-base">
              Recibimos tus datos para el <strong className="text-ink">{producto.nombre}</strong>. Te contactamos por WhatsApp en breve.
            </p>
            <button onClick={onClose} className="mt-2 bg-celtec-green hover:bg-celtec-greendark text-white font-display font-bold py-3 px-8 rounded-xl text-lg">
              Entendido
            </button>
          </div>
        )}
        ...
        {paso === "error" && (
          <div className="text-center space-y-3 py-4">
            ...
            <a href="https://wa.me/526862901448" className="inline-block mt-2 bg-celtec-green hover:bg-celtec-greendark text-white font-display font-bold py-3 px-8 rounded-xl text-lg">
